 ...
 * fields are nested under `fieldData`).  It also normalises hero
...
exports.handler = async (event) => {
  ...
  const heroUrl =
    ...
    body.heroUrl ||
    (body.fieldData && (body.fieldData.featureImageUrl || (body.fieldData.hero && body.fieldData.hero.url))) ||
    '';
  const heroAlt =
    (body.hero && body.hero.alt) ||
    body.heroAlt ||
    (body.fieldData && (body.fieldData.heroAlt || (body.fieldData.hero && body.fieldData.hero.alt))) ||
    '';
