...
exports.handler = async (event) => {
    ...
    try {
        ...
        let deleted = 0;
        for (const record of recordsToDelete.slice(0, 50)) { // Limit to 50 to avoid timeout
            try {
        ...
        const maxProcessTime = 20000; // 20 seconds to leave more buffer for Netlify timeout
