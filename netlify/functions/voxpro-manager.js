        ...
        function playMedia(mediaUrl, fileType, title) {
            ...
            if (fileType === 'audio') {
                ...
                if (isPdf) {
                    ...
                    iframe.src = mediaUrl + '#toolbar=0&navpanes=0&scrollbar=1&view=FitH&zoom=page-width';
                    iframe.style.cssText = 'width: 100%; height: 500px; border: none; background: var(--bg-primary); border-radius: 4px;';
                    
                    iframe.onload = function() {
                        console.log('PDF loaded successfully via direct embedding:', mediaUrl);
                    };
                    
                    iframe.onerror = function() {
                        console.error('Failed to load PDF via direct embedding:', mediaUrl);
                        iframe.src = mediaUrl;
                    };
                    ...
                    iframe.onload = function() {
                        console.log('DOCX loaded successfully via Office 365 viewer:', mediaUrl);
                    };
                    
                    iframe.onerror = function() {
                        console.error('Failed to load DOCX via Office 365 viewer:', mediaUrl);
                        iframe.src = mediaUrl;
                    };
