...
<body>
    ...
    <script>
        // Configuration - Direct to Xano
        const XANO_API_URL = 'https://x8k1-lell-twmt.n7.xano.io/api:pYeQctV/voxpro';
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                console.log('Starting direct upload to Xano...');
                console.log('Upload data:', uploadData);
                
                // Send directly to Xano
                ...
                showError('Upload failed. Please check your connection and try again. Error: ' + error.message);
                progressFill.style.width = '0%';
            }
